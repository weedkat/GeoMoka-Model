...
class TransformsCompose:
    ...
    """
    def __init__(self, cfg=None, input_size=None, inference=False):
        ...
        if not self.inference:
            ...
            # For inference, we only apply resize and normalization
            transforms = []
            for spec in cfg:
                if spec['name'] in ("CenterCrop", "Resize", "Normalize", "ToTensorV2"):
                    transforms.append(self.build_transforms(spec))
